...
Table~\ref{tab:paper_comparison} situates this paper relative to the closest visual-sentiment studies in the literature. The comparison highlights three dimensions in which the present paper provides incremental evidence: an A-share market context (versus U.S. or global samples in \citealp{obaid2022picture}, \citealp{ren2025investor}, and \citealp{gu2026giffluence}), a Vision Transformer image backbone explicitly anchored to Obaid--Pukthuanthong's CNN approach, and a longer 2014--2026 sample window combined with the Campbell--Thompson plus Clark--West out-of-sample validation framework that the closest Chinese counterpart \citep{zhang2025multimodal} does not implement.

\begin{table}[h!]
    \centering
    \caption{Comparison of This Paper with the Closest Visual-Sentiment Studies}
    \label{tab:paper_comparison}
    \setlength{\tabcolsep}{3pt}
    \footnotesize
    \begin{tabular}{lllll}
    \toprule
    Dimension & This paper & \citet{obaid2022picture} & \citet{zhang2025multimodal} & \citet{ren2025investor} \\
    \midrule
    Market               & China A-share          & U.S.\ (CRSP)           & China A-share         & U.S.\ (NYSE/NASDAQ)   \\
    Sample period        & 2014--2026             & 2000--2020             & 2017--2024            & 2018--2023            \\
    Photo source         & Sina Financial homepage & Wall Street Journal   & China News Service    & New York Times        \\
    Text component       & Sina headlines (BERT)  & WSJ text (CoreNLP)     & CNS text (RoBERTa)    & Not used              \\
    Image backbone       & ViT-B (replication-anchored) & Inception v3 CNN  & Inception v3 CNN      & DeepEMD (few-shot)    \\
    OOS validation       & Campbell--Thompson + Clark--West & Not reported & Not reported          & Not reported          \\
    Multiple-testing adj.\ & Bonferroni across 5 indices & N/A             & N/A                   & N/A                   \\
    Headline finding     & PhotoPes$_{t-3}$ predicts ChiNext returns; small-cap concentration & Photo pessimism predicts U.S.\ market & Multimodal $>$ unimodal in-sample & Image sentiment delays into small caps \\
    \bottomrule
    \end{tabular}

    \vspace{0.2cm}
    \footnotesize
    \textit{Note:} Field values for comparison studies are taken from the reported descriptions in their respective papers and may not capture every methodological detail. Empty cells (Not reported / N/A) indicate that the dimension was not the focus of the cited study.
\end{table}
...
The empirical results show that the sentiment-driven strategy outperformed the benchmark during the sample period. As shown in Table~\ref{tab:performance_comparison}, the strategy achieved an annualized return of 9.03\% with an annualized volatility of 24.86\%, resulting in a Sharpe ratio of 0.363. In contrast, the CSI 500 Index recorded an annualized return of 6.23\% with an annualized volatility of 25.14\%, leading to a Sharpe ratio of 0.248. The strategy demonstrated modestly superior risk control; its maximum drawdown was $-62.22$\%, compared to the benchmark's maximum drawdown of $-71.11$\%. We interpret these numbers as evidence on the existence of statistical predictability in a retail-dominated market with binding short-sale constraints and T+1 settlement, consistent with the noise-trader-with-frictions framework \citep{stambaugh2012short,han2022chinese}, rather than as a transaction-cost-net trading recommendation. The reported Sharpe ratio includes neither bid--ask spreads, stamp duties, nor market-impact costs, which historical estimates put at roughly 30--40~bps round-trip in the CSI 500 universe.
...
In terms of investment applications, this paper constructs a rule-based trading exercise that converts the in-sample predictability into an executable long-only signal. The exercise produces a higher Sharpe ratio than the CSI 500 benchmark (0.363 versus 0.248) and a smaller maximum drawdown, but the corresponding three-factor alpha relative to the \citet{liu2019size} CUFE factors is positive yet statistically insignificant. We interpret this as further evidence consistent with the noise-trader-with-frictions framework of \citet{stambaugh2012short} in a market where short-selling is constrained, rather than as a recommendation of a transaction-cost-net trading strategy; the reported figures do not include bid--ask spreads, stamp tax, or market-impact costs.
