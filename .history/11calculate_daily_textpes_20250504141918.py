...
The image sentiment analysis model uses the PCNN Twitter Dataset from the PCNN paper (AAAI 2015). You can download the dataset from: https://qzyou.github.io/projects/sa-ds/
