...
def calculate_daily_photopes(db, years, output_file=None, collection_suffix="_old"):
    ...
    for year in years:
        ...
        sentiment_collection_name = f"{year}_sentiment{collection_suffix}"
...
def main():
    ...
    df = calculate_daily_photopes(db, args.years, args.output, collection_suffix=args.collection_suffix)
